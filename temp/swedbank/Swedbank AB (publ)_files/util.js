 ...
 * 
 * Addition 2011-02-10
 * Test for use of $ was backported from util.js in DWR 2.0.6 due to 
 * co-habitation problems with JQuery in Internet Explorer.
 */
 ...
 * @see http://getahead.org/dwr/browser/util/$
 *
 * Old implementation changed to updated from DWR 2.0.6
 * 
 * var $;
 * if (!$) {
 *  $ = dwr.util.byId;
